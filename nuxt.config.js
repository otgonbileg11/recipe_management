export default {
  ...
  head: {
    title: 'Online Recipes - Latest recipes',
    htmlAttrs: {
      lang: 'en'
    },
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'A web-based recipe management application that enables users to search, save, and manage their own recipes.' },
